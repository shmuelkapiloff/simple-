...
async function seed() {
    ...
    const products = [
        ...
        },
        {
            ...
            price: 99,
            category: "accessories",
            image: "https://images.unsplash.com/photo-1606041008023-472dfb5e530f?w=300",
            featured: false,
            stock: 70,
            rating: 4.6,
            isActive: true,
    ...
    await product_model_1.ProductModel.insertMany(products);
    logger_1.logger.info(`Seed completed: ${products.length} products inserted`);
    process.exit(0);
}
seed().catch((err) => {
